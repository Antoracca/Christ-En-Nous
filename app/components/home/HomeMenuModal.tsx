...
const MenuItem = ({
  ...
  const defaultIconBgColor = isDarkMode ? 'rgba(255,255,255,0.12)' : 'rgba(30,58,138,0.1)';
  const iconBgColor = customIconBgColor || defaultIconBgColor;
    ...
    <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
      ...
      >
        <View style={[
          ...
          {
            backgroundColor: noBackground ? 'transparent' : iconBgColor,
            borderWidth: noBackground ? 1 : 0,
            borderColor: noBackground ? (isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.08)') : 'transparent',
          }
        ]}>
          {imagePath ? (
            <Image
              source={imagePath}
              style={styles.menuItemImageIcon}
              contentFit="contain"
            ...
            <Image
              source={svgPath}
              style={styles.menuItemSvgIcon}
              contentFit="cover"
              cachePolicy="memory-disk"
              tintColor={svgColor || textColor}
            />
          ) : (
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <ScrollView style={styles.menuContent} showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
            ...
            <MenuSection title="Notre Communauté" icon="home" isDarkMode={isDarkMode}>
              <MenuItem
                icon="home"
                label="Vie de l'Église"
                subLabel="Vision, Leadership, Programme"
                onPress={() => handleNavigation('/(tabs)/church')}
            ...
            <MenuSection title="Vie Spirituelle" icon="book-open" isDarkMode={isDarkMode}>
              ...
              <MenuItem
                ...
                onPress={() => handleNavigation('/(tabs)/bible/meditation')}
                isDarkMode={isDarkMode}
              />
              <MenuItem
                icon="users"
                label="Méditons Ensemble"
                onPress={() => handleNavigation('/(tabs)/bible/community')}
                isDarkMode={isDarkMode}
              />
            </MenuSection>
            ...
            <MenuSection title="CHRIST EN NOUS ACADEMY" icon="layers" isDarkMode={isDarkMode}>
              ...
              <MenuItem
                ...
                onPress={() => handleNavigation('/(tabs)/library')}
                isDarkMode={isDarkMode}
                isNew={true}
              />
            </MenuSection>
            ...
            <MenuSection title="Ministères" icon="users" isDarkMode={isDarkMode}>
              <MenuItem
                ...
                onPress={() => handleNavigation('/(tabs)/cantiques')}
                isDarkMode={isDarkMode}
              />
              <MenuItem
                imagePath={require('../../../public/assets/markos.png')}
                label="Markos (Jeunesse)"
                onPress={() => handleNavigation('/(tabs)/markos')}
                isDarkMode={isDarkMode}
                noBackground={true}
              />
            </MenuSection>
            ...
            <MenuSection title="MISSION" icon="globe" isDarkMode={isDarkMode}>
              <MenuItem
                imagePath={require('../../../public/assets/mission.png')}
                label="BOMI"
                subLabel="(Bonnes Œuvres Missions Internationales)"
                onPress={() => handleNavigation('/(tabs)/missions')}
                isDarkMode={isDarkMode}
                iconBgColor="#3B82F6"
                noBackground={false}
              />
            ...
            <MenuSection title="Autres" icon="more-horizontal" isDarkMode={isDarkMode} defaultExpanded={false}>
               <MenuItem
                icon="target"
                label="Plan de Défis"
                onPress={() => handleNavigation('/(tabs)/bible/plan')}
                isDarkMode={isDarkMode}
              />
            </MenuSection>
...
const styles = StyleSheet.create({
  ...
  menuItemIconContainer: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center', overflow: 'hidden' },
  menuItemSvgIcon: { width: 40, height: 40 },
  menuItemImageIcon: { width: 28, height: 28 },
